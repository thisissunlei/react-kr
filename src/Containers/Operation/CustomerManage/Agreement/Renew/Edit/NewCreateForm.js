...
<form onSubmit={handleSubmit(this.onSubmit)}>
				...
				<KrField grid={1/2} left={60} name="lessorContactid" component="searchPersonel" label="联系人" onChange={this.onChangeSearchPersonel} placeholder={optionValues.lessorContactName} requireLabel={true}/>
				<KrField grid={1/2} left={60} name="lessorContacttel" type="text" component="input" label="电话" requireLabel={true}/>

				<KrField grid={1/2} left={60} component="labelText" label="承租方" inline={false} value={optionValues.customerName} requireLabel={true}/>

				<KrField grid={1/2} left={60} name="leaseAddress" type="text" component="input" label="地址" requireLabel={true}/>

				<KrField grid={1/2} left={60} name="leaseContact" type="text" component="input" label="联系人" requireLabel={true}/>
				<KrField grid={1/2} left={60} name="leaseContacttel" type="text" component="input" label="电话" requireLabel={true}/>

				<KrField grid={1/2} left={60} name="communityid" component="labelText" label="所属社区" inline={false} value={optionValues.communityName} />
				...
				<KrField name="paytype" left={60} grid={1/2} component="select" label="支付方式" options={optionValues.payTypeList} />
				<KrField name="firstpaydate" left={60} component="date" label="首付款时间" requireLabel={true} /> 

				<KrField grid={1/2} left={60} name="signdate"  component="date"  label="签署时间" requireLabel={true}/>
				<KrField grid={1} left={60} name="rentaluse" type="text" component="input" label="租赁用途" placeholder="办公使用"  /> 
				<KrField grid={1/2} left={60} name="totalrent" type="text" component="input" label="租金总额" placeholder="" requireLabel={true} /> 
				<KrField grid={1/2} left={60}  name="totaldeposit" type="text" component="input" label="押金总额" requireLabel={true} />

				<KrField grid={1/1} left={60} name="contractmark" component="textarea" label="备注" />
				<KrField grid={1} left={60} name="fileIdList" component="file" label="合同附件" requireLabel={true} defaultValue={optionValues.contractFileList}/>
