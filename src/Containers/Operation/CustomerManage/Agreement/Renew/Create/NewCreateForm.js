...
<form onSubmit={handleSubmit(this.onSubmit)} style={{marginTop:50}}>
			<CircleStyle num={1} info='租赁明细' >
				...
				<KrField style={{width:370,marginLeft:90}}  name="communityid" component="labelText" label="所属社区" inline={false} value={optionValues.communityName} />
				...
				<KrField style={{width:370,marginLeft:90}}  name="paytype"   component="select" label="支付方式" options={optionValues.payTypeList} requireLabel={true} />
