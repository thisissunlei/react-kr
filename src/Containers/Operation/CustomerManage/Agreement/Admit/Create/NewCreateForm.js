				...
				<div className="detailContent">
					...
					<div className="circle"><span></span></div>
								...
								<KrField grid={1/2}  name="boardroomnum" type="hidden" component="input" />
								 ...
								 <KrField style={{width:370,marginLeft:90}} name="leaseId" component="select" label="出租方" options={optionValues.fnaCorporationList} requireLabel={true}/>
								 ...
								 <KrField style={{width:370,marginLeft:90}}  component="labelText" label="承租方" value={optionValues.customerName} inline={false}/>
								 ...
								 <KrField style={{width:370,marginLeft:90}}  name="leaseContact" type="text" component="input" label="联系人" requireLabel={true}
								 ...
								 <KrField style={{width:370,marginLeft:90}} component="labelText" label="所属社区" value={optionValues.communityName} inline={false}/>
								 ...
								 <KrField style={{width:370,marginLeft:90}} name="paymentId" type="text" component="select" label="付款方式" options={optionValues.paymentList} requireLabel={true}/>
							 ...
							 <KrField style={{width:830,marginLeft:90}}  name="contractmark" type="textarea" component="textarea" label="备注" maxSize={200}/>
