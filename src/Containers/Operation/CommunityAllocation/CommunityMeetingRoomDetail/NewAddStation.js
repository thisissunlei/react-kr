    ...
    console.log(';;--',State.isCode);
      ...
      <form onSubmit={handleSubmit(this.onSubmit)}>
           <div className="title" style={{marginBottom:"30px"}}>
            ...
            <KrField grid={1/2} style={{marginTop:1,width:262}} name="code" component="input"  label="空间名称" requireLabel={true}
            ...
            <KrField grid={1/2} style={{width:262,marginLeft:28}}  name="floor" component="select" label="所在楼层"
						 ...
						 <KrField grid={1/2} style={{width:262}}  name="area" component="input" label="面积（㎡）"/>
						 <KrField grid={1/2} style={{width:262}}  name="area" component="input" label="可容纳人数"/>
            <KrField grid={1/2} style={{width:262}}  name="area" component="input" label="空间位置"/>
						...
						<KrField grid={1/2} style={{width:262,marginLeft:28}}  name="floor" component="select" label="空间类型"
						 requireLabel={true} options={State.floorData} onChange={this.floorChange}/>
