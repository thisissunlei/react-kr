...
class ImportData extends React.Component{
	...
	onLoadDemo=()=>{
	 ...
	 onSubmit=()=>{
		 ...
		 form.append('communityId',this.props.CommunityMeetingModel.communityId);
			 ...
			 if (xhr.readyState === 4) {
				 if (xhr.status === 200) {
					 if (xhr.response && xhr.response.code > 0) {
						 ...
						 _this.props.CommunityMeetingModel.openImport=false;
						 Message.success('上传成功');
						 _this.props.CommunityMeetingModel.searchParams={
						   time:+new Date(),
						   page:1,
						   pageSize:15,
						   communityId:_this.props.CommunityMeetingModel.communityId	
						 }
					 } else {
