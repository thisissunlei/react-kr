...
export default class AdvanceSearchDateForm extends Component {
	...
	render() {
		...
		return(
			<div className="ui-upload-header" style={style}>
				...
				<div className="ui-uploadimg-fresh-delete" style={{display:this.state.operateImg?"block":"none"}}>
					<div className="ui-uploadimg-operateimg ui-uploadimg-operateimg-left" onClick={this.reFreshImg}>
						<img className="ui-uploadimg-operateimg-btn ui-uploadimg-operateimg-refresh"/>
					...
					<div className="ui-uploadimg-operateimg ui-uploadimg-operateimg-right" onClick={this.deleteImg}>
						<img className="ui-uploadimg-operateimg-btn ui-uploadimg-operateimg-delete"/>
					</div>
				</div>
			</div>
		);
