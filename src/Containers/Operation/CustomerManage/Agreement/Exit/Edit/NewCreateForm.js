...
<form onSubmit={handleSubmit(this.onSubmit)} enctype="multipart/form-data">
				...
				<KrField grid={1/2}  name="lessorAddress" type="text" component="labelText" label="地址" inline={false}  value={changeValues.lessorAddress}  defaultValue="无"/>
				...
				<KrField grid={1/2}  component="labelText" label="承租方" inline={false} value={optionValues.customerName}/>
				...
				<KrField grid={1/2}  name="communityid" component="labelText" label="所属社区" inline={false} value={optionValues.communityName} />
				...
				<KrField grid={1/2}  name="withdrawdate" component="labelText" inline={false} label="撤场日期" requireLabel={true}/>
