    ...
    render() {
        ...
        return (
            <div className="g-account-list">
                ...
                <Dialog className='setPermission' title="注意：社区经理请同时选中社区负责人+社区运营；其他部门同事（含技术部）请勿授予招商与运营的角色；其他部门同事转岗运营时需减少数据权限；组长与超级管理员权限请通过邮件申请" bodyStyle={{maxHeight:600}}  modal={true} open={this.state.openSetAcc} onClose={this.openSetAcc} contentStyle={{
                    width: 1016,
                }}>
