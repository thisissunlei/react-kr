								...
								<TableRowColumn style={{overflow:"visible",textAlign: "center",}}
									...
									component={
										(value,oldValue,itemData) => {
											...
											return (
												<div className="appointment-visit-time-visit" style={{color:color,top:9}} onClick={this.columnClick.bind(this,itemData)}> <KrDate value={value} format="yyyy-mm-dd HH:MM:ss"/></div>
											);
										}
									}
								>
