...
class NewCreateForm extends React.Component {
	...
	onChangeLeaseBeginDate(value) {
		...
		let {initialValues,changeValues} = this.props;
		let delStationVos;
...
<form className="m-edit-increase m-edit-increase-dialog-form" onSubmit={handleSubmit(this.onSubmit)} style={{marginTop:-15}}  >
			<div className="cheek" style={{paddingLeft:0,marginLeft:23}}>
				...
				<KrField style={{width:262,marginLeft:25}}  name="totalrent" type="text" component="labelText" inline={false} label="服务费总额" placeholder="" value={allRent} defaultValue={initialValues.totalrent} requireLabel={true}
