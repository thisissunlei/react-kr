			...
			<form  style={{marginTop:-9}}>
				...
				<div className='s-date-search'>
				    <ListGroup>
						...
						<ListGroupItem><div className='statis-date-end'><KrField  name="endDate" component="date" onChange={this.props.onEndNotChange} placeholder={today} dateNoSecond='true'  /></div></ListGroupItem>
					</ListGroup>
				</div>
			</form>
		);
