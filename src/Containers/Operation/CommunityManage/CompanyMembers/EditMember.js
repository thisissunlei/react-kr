		...
		return (
			<div className="edit-form">
				<form onSubmit={handleSubmit(this.onSubmit)} >
					...
					<KrField name="foreignCode" grid={1/2} label="会员卡号" component="input" left={20} onBlur={this.foreignCodeBlur}  requireLabel={true} requiredValue={true} pattern={/^\d{10}$/} errors={{requiredValue:'会员卡号为必填项',pattern:'会员卡号应由10位纯数字组成'}}/>
					...
					<KrField name="email" grid={1/2} label="邮箱:" component="input" left={20}  onBlur={this.EmailonBlur}  requireLabel={true}/>
					<KrField name="name" grid={1/2}  label="姓名" component="input" right={20}  requireLabel={true} />
