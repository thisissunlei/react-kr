...
<form onSubmit={handleSubmit(this.onSubmit)} >
				<KrField name="wherefloor" right={60}  grid={1/2} component="select" label="所在楼层" options={optionValues.floorList} multi={true} requireLabel={true}/>
				<KrField grid={1/2}  component="group" label="租赁期限" left={60} requireLabel={true}>
					<ListGroup>
