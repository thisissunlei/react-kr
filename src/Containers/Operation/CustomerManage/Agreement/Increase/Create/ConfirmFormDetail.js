	...
	render(){
	  ...
	  return (
		  ...
		  <div>
							 ...
							 <KrField grid={1/2}  name="signdate"  component="labelText"  label="签署时间" value={detail.signdate} defaultValue="无"/> 

							 <KrField grid={1/2} name="firstpaydate" component="labelText" label="首付款时间" value={detail.firstpaydate} defaultValue="无"/> 

							 <KrField grid={1/2}  name="stationnum"  component="labelText" label="租赁工位" value={detail.stationnum} defaultValue="0"/> 
							 <KrField grid={1/2}  name="boardroomnum"  component="labelText" label="租赁会议室" value={detail.boardroomnum} defaultValue="0"/> 
