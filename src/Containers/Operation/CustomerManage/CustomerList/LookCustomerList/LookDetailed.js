	...
	render(){
		...
		return(
	      <div className="m-LookDetailed" style={{marginTop:8}}>
				...
				<li className="everyText spetial" style={{paddingLeft:62}}><span className="blueDrop"></span><KrField grid={1/2} label="预计入驻时间:" style={{marginLeft:-10,width:'auto'}} component="labelText" value={<KrDate style={{marginTop:5}} value={detail.inTime} format="yyyy-mm-dd HH:MM:ss"/>} inline={true} /></li>
