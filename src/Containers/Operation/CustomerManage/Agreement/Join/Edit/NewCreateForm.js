	...
	<CircleStyle num="1" info="租赁明细">
			...
			<KrField style={{width:370,marginLeft:90}} left={10} component="group" label="租赁期限" requireLabel={true}>
				...
				*/}
				...
				<KrField style={{width:370,marginLeft:70}}  name="boardroomnum" type="text" component="labelText" label="独立空间" value={changeValues.boardroomnum} defaultValue="0" requireLabel={true} inline={false}/>
