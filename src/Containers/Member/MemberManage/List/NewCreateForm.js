...
import imgLine from './images/line.png'
 ...
 class NewCreateForm extends Component{
	...
	render(){
        ...
        <KrField grid={1/2} name="foreignCode" type="input" label="会员卡号" requireLabel={true} onBlur={this.foreignCodeBlur} style={{width:'252px'}} requiredValue={true} pattern={/^\w{8}(,\w{8})*$/} errors={{requiredValue:'会员卡号为必填项',pattern:'会员卡号应由8位数字或字母组成'}}/>
