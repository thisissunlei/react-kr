...
import './index.less'
@observer
 class NewCustomerIndent extends Component{
		...
		return (
			...
			<form className="m-newMerchants" onSubmit={handleSubmit(this.onSubmit)}>
				...
				<div className="kk" style={{marginTop:30}}>		
					<KrField grid={1/2} label="拜访方式" name="sourceId" style={{width:252,marginLeft:15}} component="select" 
							options={State.selectData.customerSourceList}
							requireLabel={true}
					/>
					
					<KrField grid={1/2} label="拜访时间" name="inTime" style={{width:252,marginLeft:15}} component="date"    requireLabel={true}/>
					
					<KrField grid={1/2} label="联系人" name="customerWechat" style={{width:252,marginLeft:15}} component="input" requireLabel={true}/>

					<KrField grid={1/2} label="客户分类" name="intentionCommunityId" component="select" style={{width:252,marginLeft:15}} 
							options={State.selectData.communityBaselist}
							requireLabel={true}
					/>
					<KrField grid={1/2} label="联系方式" name="customerWechat" style={{width:252,marginLeft:15}} component="input" requireLabel={true}/>
					...
					<KrField grid={1/2} label="沟通情况" name="remark" style={{width:520,marginLeft:15}} heightStyle={{height:"80px"}}  component="textarea"  maxSize={100} requireLabel={true} />
					<KrField grid={1/2} label="备注" name="remark" style={{width:520,marginLeft:15}} heightStyle={{height:"80px"}}  component="textarea"  maxSize={100} requireLabel={false} />
				</div>		
...
export default reduxForm({ form: 'NewCustomerIndent',validate})(NewCustomerIndent);
