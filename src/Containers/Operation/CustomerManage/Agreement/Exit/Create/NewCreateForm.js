...
<form onSubmit={handleSubmit(this.onSubmit)}  style={{marginTop:50}}>
				...
				<KrField style={{width:370,marginLeft:90}} name="contractcode"  grid={1/2} type="text" component="input" label="合同编号" requireLabel={true}
				...
				<KrField name="depositamount" style={{width:370,marginLeft:90}} type="text" component="input" label="退押金总额"  requireLabel={true}
