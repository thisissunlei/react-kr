...
export default(
    ...
    <Route path="/" component={Master}>
        ...
        <IndexRoute component={Welcome} onEnter={({
            params
        }, replace) => {
        ...
        <Route path="index" component={Welcome} onEnter={({
            params
        }, replace) => {
            Store.dispatch(Actions.switchSidebarNav(false));
        }} onLeave={({
        ...
        <Route path="initialize" component={Initialize}/> {/*demo*/}
        ...
        <Route path="community" component={Basic}>
            <IndexRedirect to="communityManage/detail"/> {/*销控表*/}
        ...
        <Route path="operation" component={Basic}>
            <Route path="index" component={Operation.Home}/> {/*分组模版管理*/}
            <Route path="groupSetting" component={Operation.GroupSetting}/> {/*基础配置*/}
            ...
            <Route path="customerManage" component={Basic}>
                ...
                <Route path=":customerId/" component={Basic}>
                    ...
                    <Route path="order" component={Basic}>
                        ...
                        <Route path=":orderId/Edit" component={Operation.CustomerManage.Order.Edit} name="customerManage_order_edit"/> {/*合同信息*/}
	...
	*/}
        ...
        {/*帮助*/}
        <Route path="help" component={Help}/> {/*404*/}
