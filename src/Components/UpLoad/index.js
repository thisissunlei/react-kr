...
export default class UpLoadList extends React.Component {
	...
	onChange=(event)=>{
		...
		let {index,category,isPublic} = this.props;
		let _this = this;
		...
		xhr.open('GET', '/api/krspace-op-web/sys/upload-policy?isPublic='+isPublic+'&category='+category, true);
	...
	download(item){
		window.location.href = '/api/krspace-op-web/sys/downFile?fileId='+item.id;
