	...
	render(){
		...
		return (
			...
			<form onSubmit={handleSubmit(this.onSubmit)}>
				...
				<KrField grid={1/2} name="propcode" style={{width:200}} component="input" label="属性编码" requireLabel={true}/>
...
export default reduxForm({ form: 'NewOrders',validate, enableReinitialize:true,keepDirtyOnReinitialize:true})(NewOrders);
