 ...
 //社区管理－访客记录-准备数据
  ...
  'visit-record-edit-deatil':{
   ...
   'get-question-list':{
    ...
    //社区经营新销控表
   'control-table':{
      url: 'http://shang.krspace.cn:8082/api/krspace-finance-web/cmt/sell-control/list?communityId={communityId}&customerName={customerName}&page={page}&pageSize={pageSize}',
      method: 'get'
   },
