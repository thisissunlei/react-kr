...
<form onSubmit={handleSubmit(this.onSubmit)} enctype="multipart/form-data">
				...
				<KrField grid={1/2}  name="lessorAddress" type="text" component="labelText" inline={false} label="地址" value={changeValues.lessorAddress}/> 
                  ...
                  <DotTitle title='租赁明细'>
				        <Grid>
							<Row>
								<Col align="right">
									<ButtonGroup>
									    <Button label="录入单价" primary={true} onTouchTap={this.openStationUnitPriceDialog} />
