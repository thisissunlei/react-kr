		      	...
		      	<div className="title" >
    				...
    				<div style={{height:5}}></div>
    				 <div className="m-LookDetailed" style={{marginTop:8}}>
							...
							<li className="everyText" style = {{display:'block'}}><span className="blueDrop"></span><KrField grid={1/2} label="备注:" style={evenStyle} component="labelText" value={detail.corDesc} inline={true} /></li>
