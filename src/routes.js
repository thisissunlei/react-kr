								...
								<Route path="order" component={Basic}>
									...
									<Route path=":orderId/agreement" component={Basic}>
																	...
																	<Route path="admit" component={Basic}>
																		...
																		<Route path="print" component={Operation.CustomerManage.Agreement.Admit.Print}/>
																	</Route>
																	...
																	<Route path="increase" component={Basic}>
																		...
																		<Route path="print" component={Operation.CustomerManage.Agreement.Increase.Print}/>
																	</Route>
																	...
																	<Route path="renew" component={Basic}>
																		...
																		<Route path="print" component={Operation.CustomerManage.Agreement.Renew.Print}/>
																	</Route>
																	...
																	<Route path="reduce" component={Basic}>
																		...
																		<Route path="print" component={Operation.CustomerManage.Agreement.Reduce.Print}/>
																	</Route>
																	...
																	<Route path="exit" component={Basic}>
																		...
																		<Route path="print" component={Operation.CustomerManage.Agreement.Exit.Print}/>
																	</Route>
