            ...
            <div>
              <form onSubmit={handleSubmit(this.onSubmit)} style={{width:636,marginTop:20}}  >
                ...
                <KrField
                    ...
                    placeholder="排序号"
                />
                <KrField style={{width:262,marginTop:6,marginLeft:28}} name="sex" component="group" label="是否显示" grid={1} requireLabel={false}>
                    <KrField style={{marginTop:6}} name="sex" label="显示" type="radio" value='MALE' />
                    <KrField style={{marginTop:6}} name="sex" label="不显示" type="radio" value='FAMALE' />
 				</KrField>
               <KrField
                  grid={1}
                  left={42}
                  ...
                  component="textarea"
                  maxSize={50}
                  style={{marginTop:6,height:78,marginLeft:28}}
                  label="描述"
                />
