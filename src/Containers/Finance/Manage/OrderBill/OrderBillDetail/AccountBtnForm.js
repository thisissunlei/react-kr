...
class AccountBtnForm extends Component {
    ...
    contractRender = () => {
        if (this.props.contractList != '无' && this.props.stationPayment != '无') {
            return <div style={{
                ...
                <KrField grid={1 / 2} name="stationPaymentName" right={42} component="input" label={this.props.stationPayment.propname} type="text" style={{
                    marginRight: -12
                }} onChange={this.stationMoneyChange}/>
    ...
    render() {
        ...
        return (
            <div className='ui-quit-wrap' style={{
                marginLeft: 3
            }}>
                <form onSubmit={handleSubmit(this.onSubmit)} style={{
                    ...
                    <KrField name="preCode" grid={1 / 2} component="group" label="金额正负" requireLabel={true} style={{
                        marginLeft: -12
                    }}>
                        <KrField name="preCode" label="正" type="radio" value="0" style={{
                            marginTop: 5,
                            display: 'inline-block',
                            marginRight: -209
                        }}/>
                    ...
                    <KrField grid={1 / 2} name="operatedate" right={45} type="date" component="date" label="挂账日期" requireLabel={true} style={{
                        marginTop: 3
                    }}/>
                    <KrField grid={1 / 2} name="fileids" component="file" label="上传附件" style={{
                        marginLeft: -12
                    }} defaultValue={[]}/>
                    ...
                    <div style={{
                        ...
                        {accountDetail.map((item, index) => {
                            ...
                            if (index % 2 == 0) {
                                return <KrField key={index} grid={1 / 2} style={{
                                    marginTop: 5,
                                    marginRight: -12
                                }} right={42} label={item.categoryName} component="input" name={'fix' + item.id} type="text" onBlur={this.moneyCheck}/>
...
export default reduxForm({form: 'AccountBtnForm', validate, enableReinitialize: true, keepDirtyOnReinitialize: true})(AccountBtnForm);
