		...
		<div className="cheek" style={{paddingLeft:0,marginLeft:23}}>
			...
			<div className="detailList" style={{marginTop:"-35px",width:"620px",marginLeft:"35px"}}>
				...
				*/}
				...
				<KrField style={{width:262,marginLeft:25}} name="totalrent" type="text" component="labelText" label="服务费总额" placeholder="" inline={false} value={allRent} defaultValue={initialValues.totalrent} requireLabel={true}
