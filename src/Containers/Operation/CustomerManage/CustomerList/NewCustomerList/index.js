			...
			<form className="m-newMerchants" onSubmit={handleSubmit(this.onSubmit)}>
				...
				<div className="cheek">
							...
							<div className="small-cheek">
									...
									<KrField grid={1/2} label="意向工位类型" name="proptype" component="select" style={{width:252,marginLeft:15}} 
											options={[
												{value:'PAYMENT',label:'回款'},
											   	{value:'INCOME',label:'收入'},
										   	]}
									...
									<KrField grid={1/2} label="意向入驻社区" name="proptype" component="select" style={{width:252,marginLeft:15}} 
											options={[
										    	{value:'PAYMENT',label:'回款'},
										    	{value:'INCOME',label:'收入'},
											]}
						...
						<div className="small-cheek">
								...
								<KrField grid={1/2} label="是否已有办公室" name="enableflag" style={{width:252,marginLeft:15}} component="group" requireLabel={true}>
					              	<KrField name="enableflag1" label="是" type="radio" value="ENABLE" onClick={this.click}/>
					             	<KrField name="enableflag1" label="否" type="radio" value="DISENABLE" onClick={this.click}/>
					            </KrField>
								<KrField grid={1/2} label="项目名称" name="propcode" style={{width:252,marginLeft:15}} component="input" requireLabel={true}/>

								<KrField grid={1/2} label="工作地点" name="work"  style={{width:252,marginLeft:15}} component="city" onSubmit={this.city}/>
