	...
	render() {
		...
		return (
			...
			<form name="infoSearchForm" className="appointment-visit-form" style={{height:50 }}>
				...
				<KrField style={{width:222,marginLeft:-44,position:"absolute",marginTop:7}} name="infoCommunity" component="select" search={true}  options={communityIdList} onChange={this.communityChange} />
