					...
					<Row>
						<Col md={12} align="center">
							<ButtonGroup>
								...
								{State.submitState?<div style = {{display:"inline-block",marginRight:30}}><Button  label="确定" type="submit" /></div>:<div  style = {{display:"inline-block",marginRight:30}}><Button  label="确定" type="button" /></div>}
