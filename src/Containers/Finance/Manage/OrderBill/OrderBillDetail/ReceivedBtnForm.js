        ...
        return (
            <div className='receive-form-middle'>
                ...
                <form onSubmit={handleSubmit(this.onSubmit)} style={{
                    ...
                    <KrField label="支付方式" grid={1 / 2} right={30} name="accountId" style={{
                        marginBottom: 5
                    }} type="select" options={optionList} requireLabel={true}/>
                    <KrField name="preCode" grid={1 / 2} left={30} component="group" style={{
                        marginLeft: -30
                    }} label="金额正负" requireLabel={true}>
                    ...
                    <KrField component="date" grid={1 / 2} right={30} style={{
                        marginTop: '-5px'
                    }} label="回款日期" name="operatedate" requireLabel={true}/>
                    <KrField label="回款总额" grid={1 / 2} right={30} style={{
                        marginTop: '-6px'
                    }} name="totalPayment" component="input" type="text" requireLabel={true} onChange={this.calcBalance}/>
                    ...
                    <KrField grid={1} left={30} style={{
                        marginLeft: -30,
                        marginTop: -10
                    }} name="fileids" component="file" label="上传附件" defaultValue={[]}/>
