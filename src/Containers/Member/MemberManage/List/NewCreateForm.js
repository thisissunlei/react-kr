...
import imgLine from './images/line.png'
 ...
 class NewCreateForm extends Component{
	...
	render(){
        ...
        <KrField grid={1/2} name="foreignCode" type="text" label="会员卡号"  onBlur={this.foreignCodeBlur} style={{width:'252px'}} requireLabel={true} pattern={/^\d{10}$/} errors={{pattern:'会员卡号应由10位纯数字组成'}}/>
