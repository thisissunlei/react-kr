    ...
    render() {
        ...
        return (
            ...
            <form onSubmit={handleSubmit(this.onSubmit)} style={{
                ...
                <KrField grid={1 / 2} name="accountcode" right={41} style={{
                    marginRight: -10
                }} type="text" label="科目编码" requireLabel={true}/>
                <KrField grid={1 / 2} name="accountname" right={41} type="text" label="科目名称" requireLabel={true}/>
                <KrField grid={1 / 2} name="accounttype" right={41} style={{
                    marginRight: -10,
                    marginTop: 4
                }} type="select" label="科目类别" options={[
                    {
                        value: 'INCOME',
                        label: '收入'
                    }, {
                ...
                <KrField grid={1 / 2} name="ordernum" type="text" right={41} style={{
                    marginTop: 3
                }} label="排序号" requireLabel={true}/>
